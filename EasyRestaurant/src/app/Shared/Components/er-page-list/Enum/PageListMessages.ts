export enum PageListMessages {
  itemRemoved = " item foi removido.",
  itemsRemoved = " items foram removidos.",
  ...
  workerCreatedSucessfull = "workerCreatedSucessfull",
  workerUpdatedSucessfull = "workerUpdatedSucessfull"
}